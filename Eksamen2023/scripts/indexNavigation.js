...
const indexNavigation = {
    ...
    init : () => {
        ...
        const navigationElement = document.querySelector('.index-navigation');
        
        if(navigationElement) {
    
            navigationElement.innerHTML = indexNavigation.template(indexNavigation.navData);
    
      
            indexNavigation.addEvents();
